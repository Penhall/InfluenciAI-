...
namespace InfluenciAI.Infrastructure.Data.Migrations
{
    ...
    [Migration("20251107125718_AddNavigationPropertiesAndMetrics")]
    partial class AddNavigationPropertiesAndMetrics
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("InfluenciAI.Domain.Entities.MetricSnapshot", b =>
                {
                    ...
                    b.HasIndex("PublicationId", "CollectedAt");
            ...
            modelBuilder.Entity("InfluenciAI.Domain.Entities.SocialProfile", b =>
                {
                    ...
                    b.HasIndex("TenantId", "Network", "ProfileId")
                        .IsUnique();
            ...
            modelBuilder.Entity("InfluenciAI.Infrastructure.Data.RefreshToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("InfluenciAI.Infrastructure.Identity.AppUser", b =>
                {
            ...
            modelBuilder.Entity("InfluenciAI.Domain.Entities.Publication", b =>
                {
                    b.HasOne("InfluenciAI.Domain.Entities.Content", "Content")
                        .WithMany("Publications")
                        .HasForeignKey("ContentId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("InfluenciAI.Domain.Entities.SocialProfile", "SocialProfile")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("InfluenciAI.Infrastructure.Identity.AppUser", null)
                        .WithMany()
